...
if ( $computed_date >= $computed_limit ){ 
	...
	{ while( $resultr=mysqli_fetch_row($listr)) 
		...
		echo"'>
		<a class='calendar' onclick=\"$('#FO_Party').hide();$('#FO_Event').load('resources/php/FO_Div_Event.php?admin=$admin&user_ID=$usertest&id=".$resultr[0]."&date=$computed_date&action=2');\" href=\"javascript:void(0)\">".$day_num."</a></td>"; };
	}
	else {echo "<td ";
